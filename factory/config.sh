...
FACTORY_AGENT="${FACTORY_AGENT:-factory/codex-agent.sh}"
...
# actually costs you.
FACTORY_MODEL_PREMIUM="${FACTORY_MODEL_PREMIUM:-gpt-5.6-sol}"
FACTORY_MODEL_CHEAP="${FACTORY_MODEL_CHEAP:-gpt-5.6-terra}"
